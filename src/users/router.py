...
@user_router.get(
    "",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.READ_ALL)],
...
@user_router.get(
    "/me",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.READ)],
    response_model=User,
)
...
@user_router.put(
    "/me",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.UPDATE)],
    response_model=User,
)
...
@user_router.delete(
    "/me",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.DELETE)],
...
@user_router.put(
    "/{user_id}",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.UPDATE_ALL)],
    response_model=User,
)
...
@user_router.delete(
    "/{user_id}",
    dependencies=[Permit(BusinessElement.USERS, PermissionAction.DELETE_ALL)],
    response_model=Message,
)
